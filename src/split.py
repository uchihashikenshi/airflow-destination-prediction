...
DEFAULT_INPUT = os.path.join(FILE_DIR, '../data/alignmented_data.csv') #TODO set input data path
DEFAULT_TRAIN = os.path.join(FILE_DIR,
                             '../data/prepared/data_train_' + NOW + '.csv') #TODO set train data path
DEFAULT_VALID = os.path.join(FILE_DIR,
                             '../data/prepared/data_valid_' + NOW + '.csv') #TODO set valid data path
RANDOM_SEED = 1234
VALID_RATIO = 0.25
