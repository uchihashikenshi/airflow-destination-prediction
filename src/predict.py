...
DEFAULT_INPUT = os.path.join(FILE_DIR, '../data/test.csv')
DEFAULT_OUTPUT = os.path.join(FILE_DIR, '../data/prediction.csv') #TODO set prediction path
DEFAULT_PIPELINE = os.path.join(FILE_DIR, '../data/pickles/model.pkl')
DEFAULT_FEATURES = [''] #TODO set data names
...
def main(**kwargs):
    """
    load test data, predict house price for test data, and create a file for prediction
    """
